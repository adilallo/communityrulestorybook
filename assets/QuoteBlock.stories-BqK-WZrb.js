import{j as a,r as q}from"./iframe-B0rGyZZI.js";import{n as N}from"./image-BUdaRZjp.js";import"./preload-helper-BRgZCzxC.js";const j=({className:r=""})=>a.jsx("svg",{className:`text-[var(--color-surface-inverse-brand-primary)] opacity-100 w-full h-full md:max-w-[640px] lg:max-w-[850px] xl:max-w-[1100px] ${r}`,viewBox:"400 0 442 163","aria-hidden":"true",overflow:"visible",preserveAspectRatio:"xMinYMin meet",children:a.jsxs("g",{fill:"currentColor",children:[a.jsxs("g",{className:"md:hidden",children:[a.jsx("ellipse",{cx:"490",cy:"80",rx:"300",ry:"100",transform:"rotate(-20 600 90)"}),a.jsx("ellipse",{cx:"508",cy:"250",rx:"300",ry:"110",transform:"rotate(-25 600 90)"}),a.jsx("ellipse",{cx:"550",cy:"420",rx:"300",ry:"120",transform:"rotate(-25 600 90)"})]}),a.jsxs("g",{className:"hidden md:block",children:[a.jsx("ellipse",{cx:"590",cy:"70",rx:"300",ry:"110",transform:"rotate(-30 600 90)"}),a.jsx("ellipse",{cx:"680",cy:"250",rx:"300",ry:"110",transform:"rotate(-30 600 90)"}),a.jsx("ellipse",{cx:"670",cy:"400",rx:"300",ry:"120",transform:"rotate(-30 600 90)"})]})]})});j.__docgenInfo={description:"",methods:[],displayName:"QuoteDecor",props:{className:{defaultValue:{value:'""',computed:!1},required:!1}}};const s=({variant:r="standard",className:k="",quote:d="The rules of decision-making must be open and available to everyone, and this can happen only if they are formalized.",author:t="Jo Freeman",source:u="The Tyranny of Structurelessness",avatarSrc:m="assets/Quote_Avatar.svg",id:S,fallbackAvatarSrc:A="assets/Quote_Avatar.svg",onError:n})=>{const[p,g]=q.useState(!1),[x,v]=q.useState(!0),f={compact:{container:"py-[var(--spacing-scale-032)] px-[var(--spacing-scale-016)]",card:"py-[var(--spacing-scale-032)] px-[var(--spacing-scale-016)] md:py-[var(--spacing-scale-040)] md:px-[var(--spacing-scale-024)] rounded-[var(--radius-measures-radius-small)]",gap:"gap-[var(--spacing-scale-016)] md:gap-[var(--spacing-scale-024)]",avatarGap:"gap-[var(--spacing-scale-012)]",avatar:"w-[48px] h-[48px] md:w-[64px] md:h-[64px]",quote:"text-[16px] leading-[120%] md:text-[20px] md:leading-[110%]",author:"text-[10px] leading-[120%] md:text-[12px]",source:"text-[10px] leading-[120%] md:text-[12px]",showDecor:!1},standard:{container:"md:py-[var(--spacing-scale-032)] md:px-[var(--spacing-scale-016)] lg:p-[var(--spacing-scale-064)]",card:"py-[var(--spacing-scale-064)] px-[var(--spacing-scale-020)] md:py-[var(--spacing-scale-064)] md:px-[var(--spacing-scale-048)] md:rounded-[var(--radius-measures-radius-medium)] lg:py-[var(--spacing-scale-064)] lg:pl-[120px] lg:pr-[320px]",gap:"gap-[var(--spacing-scale-024)] md:gap-[var(--spacing-scale-048)] lg:gap-[var(--spacing-scale-064)] xl:gap-[105px]",avatarGap:"gap-[var(--spacing-scale-020)] lg:gap-[var(--spacing-scale-018)] xl:gap-[var(--spacing-scale-032)]",avatar:"md:w-[120px] md:h-[120px] lg:w-[150px] lg:h-[150px] xl:w-[200px] xl:h-[200px]",quote:"text-[18px] leading-[120%] md:text-[36px] md:leading-[110%] md:tracking-[0px] lg:text-[52px] xl:text-[64px]",author:"text-[12px] leading-[120%] md:text-[18px] md:leading-[120%] md:tracking-[0.24px] lg:text-[24px] xl:text-[32px]",source:"text-[12px] leading-[120%] md:text-[18px] md:leading-[120%] md:tracking-[0.24px] lg:text-[24px] xl:text-[32px]",showDecor:!0},extended:{container:"py-[var(--spacing-scale-048)] px-[var(--spacing-scale-024)] md:py-[var(--spacing-scale-064)] md:px-[var(--spacing-scale-032)] lg:py-[var(--spacing-scale-080)] lg:px-[var(--spacing-scale-048)]",card:"py-[var(--spacing-scale-080)] px-[var(--spacing-scale-032)] md:py-[var(--spacing-scale-096)] md:px-[var(--spacing-scale-064)] md:rounded-[var(--radius-measures-radius-large)] lg:py-[var(--spacing-scale-112)] lg:pl-[160px] lg:pr-[400px]",gap:"gap-[var(--spacing-scale-032)] md:gap-[var(--spacing-scale-064)] lg:gap-[var(--spacing-scale-080)] xl:gap-[140px]",avatarGap:"gap-[var(--spacing-scale-032)] lg:gap-[var(--spacing-scale-040)] xl:gap-[var(--spacing-scale-048)]",avatar:"w-[80px] h-[80px] md:w-[140px] md:h-[140px] lg:w-[180px] lg:h-[180px] xl:w-[240px] xl:h-[240px]",quote:"text-[20px] leading-[120%] md:text-[40px] md:leading-[110%] md:tracking-[0px] lg:text-[60px] xl:text-[72px]",author:"text-[14px] leading-[120%] md:text-[20px] md:leading-[120%] md:tracking-[0.24px] lg:text-[28px] xl:text-[36px]",source:"text-[14px] leading-[120%] md:text-[20px] md:leading-[120%] md:tracking-[0.24px] lg:text-[28px] xl:text-[36px]",showDecor:!0}},e=f[r]||f.standard,h=S||`quote-${t.toLowerCase().replace(/\s+/g,"-")}`,y=`${h}-content`,b=`${h}-author`,T=o=>{console.warn(`QuoteBlock: Failed to load avatar image for ${t}:`,o),g(!0),v(!1),n&&n({type:"image_load_error",message:`Failed to load avatar for ${t}`,author:t,avatarSrc:m,error:o})},w=()=>{v(!1),g(!1)};return!d||!t?(console.error("QuoteBlock: Missing required props (quote or author)"),n&&n({type:"missing_props",message:"QuoteBlock requires quote and author props",quote:!!d,author:!!t}),null):a.jsx("section",{className:`${e.container} ${k}`,"aria-labelledby":y,role:"region",children:a.jsxs("div",{className:`${e.card} bg-[var(--color-surface-default-brand-darker-accent)] relative overflow-hidden`,children:[e.showDecor&&a.jsx(j,{className:"pointer-events-none absolute z-0 left-0 top-0 w-full h-full","aria-hidden":"true"}),a.jsxs("div",{className:`flex flex-col ${e.gap} relative z-10`,children:[a.jsxs("div",{className:`flex flex-col ${e.avatarGap}`,children:[a.jsxs("div",{className:"relative",children:[p?null:a.jsx(N,{src:m,alt:`Portrait of ${t}`,width:64,height:64,className:`filter sepia ${e.avatar} transition-opacity duration-300 ${x?"opacity-0":"opacity-100"}`,loading:"lazy",onError:T,onLoad:w}),x&&!p&&a.jsx("div",{className:`absolute inset-0 bg-gray-200 animate-pulse rounded-full ${e.avatar}`}),p&&a.jsx("div",{className:`flex items-center justify-center bg-gray-300 rounded-full ${e.avatar} text-gray-600 font-bold`,children:a.jsx("span",{className:"text-sm md:text-base lg:text-lg xl:text-xl",children:t.split(" ").map(o=>o[0]).join("").toUpperCase()})})]}),a.jsx("blockquote",{id:y,"aria-labelledby":b,className:"relative",children:a.jsx("p",{"data-qopen":"“","data-qclose":"”",className:["font-bricolage-grotesque font-normal",e.quote,"text-[var(--color-content-inverse-primary)]","pl-[0.6em] -indent-[0.6em]","relative before:content-[attr(data-qopen)] after:content-[attr(data-qclose)]","before:[font-family:var(--font-bricolage-grotesque)]","after:[font-family:var(--font-bricolage-grotesque)]"].join(" "),children:d})})]}),a.jsxs("footer",{className:"flex flex-col gap-[var(--spacing-scale-008)] md:gap-[var(--spacing-scale-012)] xl:gap-[var(--spacing-scale-020)]",children:[a.jsx("cite",{id:b,className:`font-inter font-normal ${e.author} text-[var(--color-content-inverse-primary)] uppercase not-italic`,children:t}),u&&a.jsx("p",{"data-qopen":"“","data-qclose":"”",className:["font-inter font-normal",e.source,"text-[var(--color-content-inverse-primary)] uppercase","pl-[0.6em] -indent-[0.6em]","relative before:content-[attr(data-qopen)] after:content-[attr(data-qclose)]","before:[font-family:var(--font-inter)] after:[font-family:var(--font-inter)]"].join(" "),children:u})]})]})]})})};s.__docgenInfo={description:"",methods:[],displayName:"QuoteBlock",props:{variant:{defaultValue:{value:'"standard"',computed:!1},required:!1},className:{defaultValue:{value:'""',computed:!1},required:!1},quote:{defaultValue:{value:'"The rules of decision-making must be open and available to everyone, and this can happen only if they are formalized."',computed:!1},required:!1},author:{defaultValue:{value:'"Jo Freeman"',computed:!1},required:!1},source:{defaultValue:{value:'"The Tyranny of Structurelessness"',computed:!1},required:!1},avatarSrc:{defaultValue:{value:'"assets/Quote_Avatar.svg"',computed:!1},required:!1},fallbackAvatarSrc:{defaultValue:{value:'"assets/Quote_Avatar.svg"',computed:!1},required:!1}}};const F={title:"Components/QuoteBlock",component:s,parameters:{layout:"fullscreen",docs:{description:{component:`
...
}`,...c.parameters?.docs?.source}}};const V=["Default","AllVariants","ErrorState"];export{i as AllVariants,l as Default,c as ErrorState,V as __namedExportsOrder,F as default};
